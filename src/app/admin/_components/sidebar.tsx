...
import { Shield, LayoutDashboard, BarChart, Users, TrafficCone, MessageSquare, Settings, Bot, Menu, X, Home } from "lucide-react";
...
const navLinks = [
  ...
  { href: "#", label: "AI Predictions", icon: Bot },
  { href: "#", label: "Analytics", icon: BarChart },
  { href: "#", label: "Staff Management", icon: Users },
  { href: "#", label: "Traffic Control", icon: TrafficCone },
